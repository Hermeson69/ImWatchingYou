...
Terminal do servidor exibindo os dados recebidos em tempo real: timestamp, IP do cliente (celular), nível de bateria do celular do cliente e coordenadas GPS do mesmo(latitude e longitude).
